...
import { LGPD_CONSENT_VERSION, recordConsentDecision, signInOrCreateWithPassword, toLoginEmail } from "../lib/firebase";
            ...
            <div className="p-6 md:p-8 pb-4 border-b border-slate-100 flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-[10px] font-black text-slate-400 uppercase tracking-wider">Primeiro acesso · versão {LGPD_CONSENT_VERSION}</div>
                </div>
              </div>
            ...
            <div className="flex-1 overflow-y-auto px-6 md:px-8 py-5 space-y-6 text-xs text-slate-600 leading-relaxed scrollbar-thin">
              <div className="bg-[#FFF0F6] border border-[#CD176D]/15 p-4 rounded-2xl flex items-start gap-3">
                ...
                <p className="text-[#CD176D] font-extrabold text-[11px] leading-relaxed">
                  Este aviso explica como os dados são tratados no Portal e registra sua ciência antes do primeiro acesso.
                </p>
              </div>

              <div className="space-y-2">
                <h4 className="font-extrabold text-slate-800 uppercase tracking-tight text-[11px]">1. Controlador e finalidade</h4>
                <p>A organização responsável pelo Portal deve ser identificada na política completa. Os dados são usados para autenticação, controle de permissões, gestão operacional e apresentação de indicadores.</p>
              </div>

              <div className="space-y-2">
                <h4 className="font-extrabold text-slate-800 uppercase tracking-tight text-[11px]">2. Dados e segurança</h4>
                <p>Podem ser tratados dados de acesso, perfil, permissões, registros operacionais e logs de segurança. O acesso deve seguir autenticação, autorização por função e as regras de segurança configuradas para o serviço.</p>
              </div>

              <div className="space-y-2">
                <h4 className="font-extrabold text-slate-800 uppercase tracking-tight text-[11px]">3. Compartilhamento e retenção</h4>
                <p>Os dados podem ser armazenados em serviços contratados pela organização e compartilhados somente quando necessário à operação, segurança ou cumprimento de obrigação legal. Prazos e fornecedores devem constar na política completa.</p>
              </div>

              <div className="space-y-2">
                <h4 className="font-extrabold text-slate-800 uppercase tracking-tight text-[11px]">4. Direitos do titular</h4>
                <p>Você pode solicitar acesso, correção, informação sobre o tratamento, eliminação quando aplicável e revogação do consentimento pelo canal oficial do controlador. O canal do encarregado deve ser informado na política completa.</p>
              </div>
            </div>
