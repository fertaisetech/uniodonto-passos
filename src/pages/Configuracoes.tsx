...
export function Configuracoes() {
  ...
  React.useEffect(() => {
    ...
    setProfilePhotoPreview(profile.localPhotoUrl || profile.photoUrl || null);
  }, [profile]);
  ...
  const handleOpenAddModal = () => {
    if (!canManageUsers) {
      showToast("Somente Fertize Tech pode cadastrar usuários.", "error");
      return;
    }
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-5 border-b border-slate-100 mb-6">
                  ...
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                    ...
                    <button
                      ...
                      className="bg-[#CD176D] text-white hover:bg-[#A60069] transition-all rounded-xl px-4 py-1.5 text-xs font-black flex items-center justify-center gap-1.5 shadow-sm active:scale-95 duration-100 focus:outline-none focus:ring-2 focus:ring-[#CD176D]/35 disabled:opacity-40 disabled:cursor-not-allowed"
