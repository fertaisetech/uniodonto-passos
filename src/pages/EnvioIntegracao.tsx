...
import { buildRecordFromEnvioState, saveMonthlyDashboard, type SummaryData } from "../lib/dashboardData";
...
export function EnvioIntegracao() {
  ...
  const executeSubmission = async () => {
    ...
    try {
      ...
      await saveMonthlyDashboard(selectedMonth, record, profile);
      setShowSubmitModal(false);
      triggerToast(`Mês ${selectedMonth} salvo e sincronizado.`, "success");
    } catch (error) {
